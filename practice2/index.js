...
// for (let a = 0; a < jobData.hits.length; a++){
// console.log(jobData.hits[a].jobTitle)
// console.log ("Benefits:")
// for (let i=0; i < jobData.hits[a].benefits.length; i++){
...
for (let a = 0; a < jobData.hits.length; a++){
    console.log(`Title: ${jobData.hits[a].jobTitle}`)
    console.log(`Salary: ${jobData.hits[a].jobSalary}$`)
    for (let b = 0; b < jobData.hits[a].locations.length; b++){
    console.log(`Location: \n - ${jobData.hits[a].locations[b]}`)
    }
    console.log ("Benefits:")
    for (let i=0; i < jobData.hits[a].benefits.length; i++){
        console.log(`- ${jobData.hits[a].benefits[i].benefitValue}`)
    ...
    console.log ("Skills:")
    for (let c = 0; c < jobData.hits[a].skills.length; c++){
        console.log(`- ${jobData.hits[a].skills[c]}`)
    }
    console.log ("----------------------------")
}
